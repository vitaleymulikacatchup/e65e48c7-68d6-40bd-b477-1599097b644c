...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury Accommodation & Premium Service",
  description: "Experience unparalleled luxury at Grandeur Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service for the discerning traveler.",
  keywords: "luxury hotel, premium accommodation, 5-star hotel, fine dining, spa wellness, concierge service, business travel, luxury hospitality",
  openGraph: {
    title: "Grandeur Hotel - Luxury Accommodation & Premium Service",
  ...
  twitter: {
    ...
    description: "Experience unparalleled luxury with premium rooms, world-class amenities, and exceptional service.",
